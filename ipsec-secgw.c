...
const char *MY_IPS_STRING[] = { "192.168.5.1",   "192.168.6.1",   "192.168.7.1",
                                "192.168.105.1", "192.168.106.1", "192.168.107.1" };

uint32_t MY_IPS_DECIMAL[] = {
    3232236801, 3232237057, 3232237313, 3232262401, 3232262657, 3232262913
};
