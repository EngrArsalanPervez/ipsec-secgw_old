...
static void print_stats_cb(__rte_unused void* param) {
  ...
  printf(
      ...
      total_packets_rx, total_packets_tx, total_packets_dropped, total_rxBytes,
      total_txBytes, total_rxBytesNormalized, total_txBytesNormalized,
      total_rxRate, total_txRate);
...
static void send_packets_eth(struct rte_mbuf* pkts[],
                             uint8_t port,
                             uint8_t qid) {
...
void handle_packets(struct rte_mbuf** pkts,
                    uint16_t nb_pkts,
                    uint16_t portid,
