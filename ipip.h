...
static inline void *ipip_outbound(struct rte_mbuf *m, uint32_t offset, uint32_t is_ipv6,
...
static inline struct ip *ip4ip_outbound(struct rte_mbuf *m, uint32_t offset, struct ip_addr *src,
                                        struct ip_addr *dst)
{
    return ipip_outbound(m, offset, 0, src, dst);
}

static inline struct ip6_hdr *ip6ip_outbound(struct rte_mbuf *m, uint32_t offset,
                                             struct ip_addr *src, struct ip_addr *dst)
{
