...
cp -r config/dpdk_hclos.sh /home/network/Desktop/bootstartup/dpdk.sh # check Interfaces, HCLOS/LCLOS
cp -r config/tmux.sh /home/network/Desktop/bootstartup/tmux.sh # python3 vEth0_0.py --device HCLOS
