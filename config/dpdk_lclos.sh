...
cd examples/ipsec-gw/config
../build/ipsec-secgw -c 0xf -n 4 --socket-mem 1024,0 --vdev "crypto_openssl" -- -p 0x3 -P -u 0x1 --config="(0,0,0),(1,0,1)" -f ./HCLOS.cfg --transfer-mode poll -t 1
