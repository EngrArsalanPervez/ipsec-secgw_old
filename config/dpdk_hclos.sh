...
./build/ipsec-secgw -c 0x3f -n 4 --socket-mem 1024,0 --vdev "crypto_openssl" -- -p 0xf -P -u 0xE --config="(0,0,0),(1,0,1),(2,0,2),(3,0,3)" -d HCLOS -f ./config/HCLOS.cfg --transfer-mode poll -t 1
